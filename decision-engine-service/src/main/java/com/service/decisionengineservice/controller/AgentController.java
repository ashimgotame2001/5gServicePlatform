package com.service.decisionengineservice.controller;

import com.service.decisionengineservice.agent.Agent;
import com.service.decisionengineservice.agent.model.AgentResult;
import com.service.decisionengineservice.service.AgentOrchestrationService;
...
/**
 * REST Controller for Decision Engine operations
 */
@Slf4j
@RestController
...
public class AgentController {
    ...
    public ResponseEntity<GlobalResponse> enableAgent(
        ...
        return orchestrationService.getAgent(agentId)
                .map(agent -> {
                    if (agent instanceof com.service.decisionengineservice.agent.BaseAgent) {
                        ((com.service.decisionengineservice.agent.BaseAgent) agent).setEnabled(enabled);
    ...
    public ResponseEntity<GlobalResponse> health() {
        ...
        healthData.put("service", "decision-engine-service");
